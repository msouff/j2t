...
from .patched_bokeh import PatchedServerConnection
...
class BokehAppHTTPConsumer(AsyncHttpConsumer):
    ...
    def __init__(self, scope):
        ...
        self.application_context = ApplicationContext(application, url=route)

        event_loop = AsyncIOMainLoop()
        event_loop.initialize()
        self.application_context._loop = event_loop
        self.bokeh_websocket_path = "/{}/ws".format(route)
